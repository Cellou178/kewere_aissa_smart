...
class _DashboardPageState extends State<DashboardPage> {
        ...
        child: CustomScrollView(slivers: [
          ...
          SliverToBoxAdapter(child: Container(
            ...
            padding: EdgeInsets.fromLTRB(
                r.horizontalPadding, 16, r.horizontalPadding, 24),
            child: Column(
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Text('Tableau de bord', style: TextStyle(
                              color: Colors.white, fontSize: r.fontXL,
              ...
              // Alerte critique
              if (_alertesCritiques > 0) AnimatedCard(
          ...
          SliverPadding(
            padding: EdgeInsets.fromLTRB(
                r.horizontalPadding, 16, r.horizontalPadding, 80),
            sliver: SliverList(delegate: SliverChildListDelegate([

              // Score
              AnimatedCard(
                delay: const Duration(milliseconds: 100),
                child: _scorePerformanceCard(),
              ),
  ...
  Widget _fabItem(IconData icon, String label, Color color,
      VoidCallback onTap) =>
      GestureDetector(
        onTap: onTap,
        child: Row(mainAxisSize: MainAxisSize.min, children: [
