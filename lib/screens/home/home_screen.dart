...
class _HomeScreenState extends State<HomeScreen> {
          ...
          bottomNavigationBar: Container(
            ...
            child: SafeArea(
              child: SizedBox(
                ...
                child: Row(children: [
                  _bottomItem(0, '🏠', 'Accueil', kBlue),
                  _bottomItem(1, '🔄', 'Cycles', kOrange),
                  _bottomItem(2, '💰', 'Finance', kRed),
                  _bottomItem(3, '🔔', 'Alertes', const Color(0xFFF59E0B)),
                  _bottomItem(4, '👤', 'Profil', kPurple),
                ]),
              ),
            ),
          ),
  ...
  Widget _bottomItem(int index, String emoji,
